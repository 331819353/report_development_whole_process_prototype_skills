...
- Do not put narrative titles, evidence summaries, conclusion text, additional information, units, or explanation copy inside component content slots. Those stay on 分块布局模板 supporting areas or narrative blocks; the slot carries only the selected component content area.
