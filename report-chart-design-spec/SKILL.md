...
8. Define chart anatomy: title, subtitle/definition, unit, metric strip, legend, axes, plot area, labels, tooltip, local filters, footer/source, and states. Keep the plot centered on the component's central axis after reserved bands are subtracted.
