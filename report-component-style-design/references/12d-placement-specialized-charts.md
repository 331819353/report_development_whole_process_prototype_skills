...
- Ordinary specialized chart blocks default to `3*2` in the page grid and must not exceed `4*3`. If the chart still cannot fit, split density, move detail to drawer/fullscreen/table, or change component type; conclusion cards are the only wide-reading exception.
