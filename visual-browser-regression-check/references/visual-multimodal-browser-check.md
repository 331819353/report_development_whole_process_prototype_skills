...
- Modern BI style-contract failure: requested or claimed modern SaaS / BI Dashboard / UI Kit styling lacks token/source proof, becomes an interchangeable bordered-card shell, piles unrelated components, makes charts visually overweight, hides reading priority, KPI-izes non-KPI modules, or relies on undocumented red/green semantics. Use `VIS-MODERN-BI-BASELINE-MISSING`, `VIS-GENERIC-SAAS-SHELL`, `VIS-COMPONENT-PILEUP`, `VIS-CHART-OVERWEIGHT`, `VIS-HIERARCHY-FLAT`, `VIS-CARD-BORDER-OVERUSE`, `VIS-KPI-EVERYWHERE`, `VIS-SEMANTIC-COLOR-OVERRELIANCE`, or `VIS-NO-INFORMATION-FLOW`.
