...
| Metric ID | Page ID | Block ID | Block coordinate | 分块布局模板 | Standard area | Area coordinate | Component slot | Slot coordinate | 组件内容区模板 | Visual role | Data object | API ID | Filter scope | Interaction ID | Export field |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Rule ID | Display target | Page ID | Block ID | Block coordinate | Standard area | Area coordinate | Component slot | Slot coordinate | Component content area template | Input metric IDs | Data object | API ID | Trigger/filter state | Rule logic/threshold | Output fields or sentence template | Evidence fields | Priority/severity | Empty/null/insufficient-data rule | Permission/masking rule | QA case |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Source component content area template | `sourceComponentContentAreaTemplateId` | Registered component content area template ID. |
...
- `triggerOwner` must be an existing template action hook, existing widget event, or a component-owned event emitted from the component content area. It must not create a new framework shell, duplicate navigation, duplicate filter bar, duplicate toolbar, or custom page/block layout.
