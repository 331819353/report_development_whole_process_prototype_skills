...
interface ComplexTableExampleTableConfig {
  ...
  headerStrongTextColor?: string;
  headerBackgroundColor?: string;
  dataTextColor?: string;
  dataStrongTextColor?: string;
...
const cardStyle = computed(() => {
  ...
  return {
    ...
    '--complex-table-primary-soft': tones.primarySoft,
    '--complex-table-success-color': tones.success,
    '--complex-table-warning-color': tones.warning,
    '--complex-table-danger-color': tones.danger,
    ...
    '--s2-sheet-border': tableConfig.borderColor,
    '--s2-sheet-background': tableConfig.dataBackgroundColor,
    '--s2-cell-border-horizontal': tableConfig.borderColor,
    '--s2-cell-border-vertical': tableConfig.borderColor,
    '--s2-header-text': tableConfig.headerTextColor,
    '--s2-header-strong-text': tableConfig.headerStrongTextColor,
    '--s2-header-background': tableConfig.headerBackgroundColor,
    '--s2-data-text': tableConfig.dataTextColor,
    '--s2-data-strong-text': tableConfig.dataStrongTextColor,
    '--s2-data-background': tableConfig.dataBackgroundColor,
    '--s2-data-cross-background': tableConfig.dataCrossBackgroundColor,
    '--s2-data-border-horizontal': tableConfig.dataBorderColor,
    '--s2-data-border-vertical': tableConfig.dataBorderColor,
  };
});
...
.complex-table-example-aux-item.tone-success b {
  color: var(--complex-table-success-color, #12a867);
}

.complex-table-example-aux-item.tone-warning b {
  color: var(--complex-table-warning-color, #e58a00);
}

.complex-table-example-aux-item.tone-danger b {
  color: var(--complex-table-danger-color, #d93025);
}
...
:deep(.s2-report-sheet-shell) {
  border-radius: 2px;
  border-color: var(--s2-sheet-border, rgba(0, 87, 217, 0.1));
}
