...
interface DetailTableExampleTableConfig {
  ...
  dataCrossBackgroundColor?: string;
}
...
const defaultTableConfig: Required<DetailTableExampleTableConfig> = {
  ...
  minColumnWidthPx: 52,
  maxVisibleColumns: 9,
  borderColor: 'rgba(127, 213, 255, 0.16)',
  dataBorderColor: 'rgba(127, 213, 255, 0.1)',
  headerTextColor: 'rgba(244, 250, 255, 0.9)',
  headerBackgroundColor: 'rgba(37, 201, 255, 0.12)',
  dataTextColor: 'rgba(244, 250, 255, 0.84)',
  dataBackgroundColor: 'rgba(5, 18, 30, 0.28)',
  dataCrossBackgroundColor: 'rgba(37, 201, 255, 0.055)',
};

const defaultToneConfig: Required<DetailTableExampleToneConfig> = {
  primary: '#0057d9',
  primarySoft: 'rgba(37, 201, 255, 0.18)',
  success: '#00a870',
  warning: '#f59e0b',
  danger: '#d93025',
  axis: '#7a8aa0',
...
const cardStyle = computed(() => {
  ...
  const tableConfig = resolvedTable.value;
  ...
  return {
    ...
    '--detail-table-primary-soft': tones.primarySoft,
    '--detail-table-success-color': tones.success,
    '--detail-table-warning-color': tones.warning,
    '--detail-table-danger-color': tones.danger,
    ...
    '--detail-table-border-horizontal': tableConfig.borderColor,
    '--detail-table-border-vertical': tableConfig.borderColor,
    '--detail-table-header-text': tableConfig.headerTextColor,
    '--detail-table-header-background': tableConfig.headerBackgroundColor,
    '--detail-table-data-text': tableConfig.dataTextColor,
    '--detail-table-data-background': tableConfig.dataBackgroundColor,
    '--detail-table-data-cross-background': tableConfig.dataCrossBackgroundColor,
    '--detail-table-data-border-horizontal': tableConfig.dataBorderColor,
    '--detail-table-data-border-vertical': tableConfig.dataBorderColor,
  };
});
...
.detail-table-example-aux-item.tone-neutral b {
  color: var(--s2-panel-option-color, #52677a);
}

.detail-table-example-aux-item.tone-success b {
  color: var(--detail-table-success-color, #12a867);
}

.detail-table-example-aux-item.tone-warning b {
  color: var(--detail-table-warning-color, #e58a00);
}

.detail-table-example-aux-item.tone-danger b {
  color: var(--detail-table-danger-color, #d93025);
}
...
.detail-table-example-footer {
  ...
  column-gap: 5px;
  overflow: visible;
  color: var(--s2-tool-button-color, rgba(22, 50, 82, 0.78));
  font-size: 10px;
  font-weight: 760;
  line-height: 1;
}
...
.detail-table-example-search {
  ...
  box-sizing: border-box;
  overflow: hidden;
  border: 1px solid var(--s2-tool-border, rgba(0, 87, 217, 0.16));
  border-radius: 999px;
  background: var(--s2-tool-background, rgba(255, 255, 255, 0.68));
  box-shadow: var(--s2-tool-shadow, inset 0 1px 0 rgba(255, 255, 255, 0.72));
...
.detail-table-example-search input::placeholder {
  color: var(--s2-tool-placeholder-color, rgba(22, 50, 82, 0.4));
}
...
.detail-table-example-filter-reset {
  ...
  padding: 0 6px;
  box-sizing: border-box;
  border: 1px solid var(--s2-tool-button-border, rgba(0, 87, 217, 0.18));
  border-radius: 999px;
  color: var(--s2-tool-button-color, #0c4ca8);
  background: var(
    --s2-tool-button-background,
    linear-gradient(180deg, rgba(255, 255, 255, 0.9), rgba(236, 245, 255, 0.76))
  );
  box-shadow: var(--s2-tool-button-shadow, 0 4px 10px rgba(0, 74, 198, 0.08));
  font: inherit;
  font-weight: 860;
  line-height: 1;
  white-space: nowrap;
...
.detail-table-example-filter[open] .detail-table-example-tool-button {
  ...
  border-color: var(--s2-tool-button-active-border, rgba(0, 87, 217, 0.42));
...
.detail-table-example-tool-button b {
  ...
  place-items: center;
  border-radius: 999px;
  color: var(--s2-tool-label-color, #0057d9);
  background: var(--s2-panel-background, #ffffff);
  font-size: 8px;
  font-style: normal;
  font-weight: 900;
}
...
.detail-table-example-filter-panel {
  ...
  gap: 5px;
  overflow: auto;
  border: 1px solid var(--s2-panel-border, rgba(0, 87, 217, 0.16));
  border-radius: 8px;
  background: var(--s2-panel-background, rgba(250, 253, 255, 0.98));
...
.detail-table-example-filter-option input {
  ...
  height: 12px;
  margin: 0;
  accent-color: var(--s2-tool-label-color, #005bd8);
}
...
.detail-table-example-sheet-pane {
  ...
  position: relative;
  overflow: hidden;
  border: 1px solid var(--s2-sheet-border, rgba(0, 87, 217, 0.12));
  border-radius: 3px;
  background: var(--s2-sheet-background, rgba(255, 255, 255, 0.26));
}
...
.detail-table-example-state {
  ...
  padding: 8px;
  box-sizing: border-box;
  color: var(--s2-tool-button-color, #667085);
  text-align: center;
  overflow: hidden;
}
...
.detail-table-example-state strong {
  color: var(--s2-header-strong-text, #15304f);
  font-size: 12px;
  font-weight: 800;
}
...
.detail-table-example-footer-text {
  min-width: 0;
  overflow: hidden;
  color: var(--s2-tool-button-color, rgba(22, 50, 82, 0.7));
  text-overflow: ellipsis;
  white-space: nowrap;
}
