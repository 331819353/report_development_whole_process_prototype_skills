...
const fallbackContext: WidgetContext = {
  ...
  navLabel: '组件内容区',
  blockId: 'cost-profit-heatmap-content-area-template',
  filters: {},
};
...
<template>
  <section class="component-content-area-template" :class="{ 'has-content-title': shouldShowContentAreaTitle }" aria-label="费用利润热力组件内容区模板">
