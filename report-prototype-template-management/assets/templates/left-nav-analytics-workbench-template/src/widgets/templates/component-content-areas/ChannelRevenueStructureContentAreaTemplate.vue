...
const fallbackContext: WidgetContext = {
  ...
  navLabel: '组件内容区',
  blockId: 'channel-revenue-structure-content-area-template',
  filters: {},
};
...
<template>
  <section class="component-content-area-template" :class="{ 'has-content-title': shouldShowContentAreaTitle }" aria-label="渠道收入结构组件内容区模板">
