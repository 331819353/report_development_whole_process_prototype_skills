...
- Verification: current template snapshot sha256 `bef03a750a3dce2f307533bd41b680c2fbd1066487380421b9c11d6e90952a4b`; run `npm run ledger:code -- --file demo/config-templates.ts --stage before` before the first project-specific edit.
