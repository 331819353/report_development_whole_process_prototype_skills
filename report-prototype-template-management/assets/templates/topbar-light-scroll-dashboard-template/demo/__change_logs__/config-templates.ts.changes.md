...
- Verification: current template snapshot sha256 `9228ef47b616b0a6807e1b3689df88587e8c6e2efc3d8dfec4a2db16ca0130e7`; run `npm run ledger:code -- --file demo/config-templates.ts --stage before` before the first project-specific edit.
