...
const fallbackContext: WidgetContext = {
  ...
  navLabel: '组件内容区',
  blockId: 'operating-revenue-metric-content-area-template',
  filters: {},
};
...
<template>
  <section class="component-content-area-template" :class="{ 'has-content-title': shouldShowContentAreaTitle }" aria-label="营业收入组件内容区模板">
