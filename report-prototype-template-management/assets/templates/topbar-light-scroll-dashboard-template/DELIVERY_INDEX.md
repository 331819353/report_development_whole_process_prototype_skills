...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| artifact-001 | prototype | Topbar light scroll business report | release-v1.0 | . | report-prototype-template-management | ready | PRD/current | validate:dashboard | baseline | npm run validate:dashboard | Configurable report template with topbar shell. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| release-v1.0 | business-report baseline | topbar-light-scroll-dashboard-template | dashboard.dataset.json | suggested in docs/prototype-data-summary.md | pending downstream | template project | validate:dashboard/build:test | package scripts | ready |
