...
When the PRD or design-thinking output supplies `displayTheme` and selected pattern cards, use them as routing evidence. Do not choose a template from display theme alone.
