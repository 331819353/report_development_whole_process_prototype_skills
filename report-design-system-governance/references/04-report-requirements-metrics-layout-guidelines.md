...
- Color follows metric direction and business meaning, not raw sign alone. In visible Chinese rate/change/completion/YoY/MoM/variance indicators, use positive-red-up and negative-green-down only when inherited company, finance, market, or explicit business convention requires it; otherwise use brand/neutral emphasis plus sign/icon/label and reserve red/green for documented status or direction semantics. Absolute loss, overdue, risk, or business-negative values may use danger red with text/icon/tag evidence.
