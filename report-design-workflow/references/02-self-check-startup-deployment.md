...
6. Visual and runtime verification.
   ...
   - Verify `brandMode`, logo/header placement, sample conclusion placement, global UI token consistency, Chinese `%` metric display, and change-rate color/icon semantics only when positive-red-up / negative-green-down is inherited or explicitly defined.
